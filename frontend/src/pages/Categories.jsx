...
function Categories() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-indigo-700 mb-6">🏷️ Categories</h1>
      ...
      <div className="bg-white rounded-2xl shadow p-6">
        ...
        {categories.length === 0 ? (
          ...
          <ul className="space-y-3">
            {categories.map((c) => (
              <li key={c.id} className="flex items-center gap-4 border border-gray-100 rounded-xl px-4 py-3 hover:bg-indigo-50 transition">
                <div className="bg-indigo-100 text-indigo-600 font-bold rounded-full w-10 h-10 flex items-center justify-center text-lg">
